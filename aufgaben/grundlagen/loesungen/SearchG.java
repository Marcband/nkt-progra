...
public class SearchG {
    public static void main(String[] args) {
        ...
        if(isRedundant(args)) System.out.println("Eingabe besitzt redundante Strings");
        else System.out.println("Eingabe besitzt keine redundanten Strings");
    }
    ...
    public static boolean isRedundant(String[] input) {
        for(int i = 0; i + 1 < input.length; i++) {
            if(hasString(input, input[i], i + 1)) return true;
        }
        return false;
    }
}
